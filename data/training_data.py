...
training_data = [
    ...
    {
        "question": "How do I connect Power BI Server to Azure Databricks?",
        "answer": "Use the Azure Databricks connector in Power BI Desktop. You'll need the server hostname, HTTP path, and proper authentication. Consider using a gateway for enterprise scenarios.",
